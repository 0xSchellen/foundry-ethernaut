...
contract Ethernaut is Ownable {
    ...
    function submitLevelInstance(address payable _instance) public returns (bool) {
        ...
        require(data.player == msg.sender, "instance not emitted for this player"); // instance was emitted for this player
        require(data.completed == false, "already submitted and completed"); // not already submitted
